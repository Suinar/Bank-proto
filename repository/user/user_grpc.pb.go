...
func (c *userRepositoryClient) ChangePassword(ctx context.Context, in *ChangePasswordRequest, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
...
func (UnimplementedUserRepositoryServer) ChangePassword(context.Context, *ChangePasswordRequest) (*User, error) {
